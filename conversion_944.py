...
class Convert_944:
    ...
    def parse_edi(self):
        ...
        with open("C:\\FTP\\GPAEDIProduction\\BK1-Nexgrill2\\Out\\944_26_" + str(sequence_number) + "_" + datetime.now().strftime("%Y%m%d%H%M%S" + ".txt"), "w") as acknowledgement_file:
            acknowledgement_file.write(completed_string)
        with open("C:\\FTP\\GPAEDIProduction\\BK1-Nexgrill2\\Out\\Archive\\944\\944_26_" + str(sequence_number) + "_" + datetime.now().strftime("%Y%m%d%H%M%S" + ".txt"), "w") as acknowledgement_file:
            acknowledgement_file.write(completed_string)